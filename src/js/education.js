            ...
            getSteps: function() {
                ...
                return [
                    ...
                    },
                    {
                        ...
                        description: isTurkish ?
                            'Bu basit puzzle durumu ile başlıyoruz. 5 numaralı parça ve boş alan yer değiştirmiş. BFS kuyruğa ekler ve sistematik olarak çözer.' :
                ...
                return [
                    {
                        ...
                        description: isTurkish ?
                            'Bu orta seviye puzzle\'da birkaç parça karışık durumda. A* Manhattan sezgiseli ile verimli çözüm bulacak.' :
                    ...
                    },
                    {
                        ...
                        description: isTurkish ?
                            'Bu karışık durumda Manhattan mesafesi parçalarla hedefe olan mesafeyi hesaplar. A* en iyi f(n) değerini seçer.' :
                ...
                return [
                    {
                        ...
                        description: isTurkish ?
                            'Bu ileri seviye puzzle\'da parçalar oldukça karışık. Farklı sezgisellerin performansını karşılaştıracağız.' :
                    ...
                    },
                    {
                        ...
                        description: isTurkish ?
                            'Bu karmaşık durumda birçok parça yanlış yerde. Linear Conflict doğru satır/sütundaki çelişkileri tespit edecek.' :
