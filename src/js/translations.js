...
window.Translations = {
    ...
    tr: {
        ...
        education: {
            ...
            iterateStepInstruction: 'Bu adım için Adım adım ilerlet butonunu kullanın.',
        ...
        errors: {
            ...
            depthLimitReached: "Derinlik sınırına ulaşıldı",
            searchStopped: "Arama durduruldu",
            // Status messages for failed searches
            failedIterationLimit: "Başarısız (İterasyon Sınırı)",
            failedTimeLimit: "Başarısız (Zaman Sınırı)",
            failedDepthLimit: "Başarısız (Derinlik Sınırı)",
            failedFrontierEmpty: "Başarısız (Çözüm Yok)",
            failedStopped: "Başarısız (Durduruldu)",
    ...
    en: {
        ...
        education: {
            ...
            iterateStepInstruction: 'Use the Iterate one step button for this feature.',
        ...
        errors: {
            ...
            // Status messages for failed searches
            failedIterationLimit: "Failed (Iteration Limit)",
            failedTimeLimit: "Failed (Time Limit)",
            failedDepthLimit: "Failed (Depth Limit)",
            failedFrontierEmpty: "Failed (No Solution)",
            failedStopped: "Failed (Stopped)",
